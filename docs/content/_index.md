---
title: "karpathy"
description: "Browse Andrej Karpathy's blog from the command line."
heroTitle: "karpathy, from the command line"
heroLead: "Browse Andrej Karpathy's blog from the command line. One pure-Go binary, no API key, output that pipes into the rest of your tools, and a resource-URI driver other programs can address."
...
karpathy links <path>           # the pages it links to, each addressable
karpathy serve --addr :7777     # the same operations over HTTP
```
...
- **As a command** for reading karpathy by hand or in a script. Start with
  the [quick start](/getting-started/quick-start/).
- **As a resource-URI driver** so a host like
  [ant](https://github.com/tamnd/ant) can address karpathy as
  `karpathy://` URIs and follow links across sites. See
