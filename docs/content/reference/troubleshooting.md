...
Most of these come down to network reality or how karpathy serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

karpathy rate-limits like any public site. karpathy already paces
...
Where a surface is gated, karpathy reads a cookie or token you supply
...
`karpathy`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what karpathy actually did
