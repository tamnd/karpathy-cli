...
func TestHostWiring(t *testing.T) {
	...
	if want := "karpathy://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("karpathy", "about")
	if err != nil || got.String() != "karpathy://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want karpathy://page/about", got.String(), err)
	}
}
